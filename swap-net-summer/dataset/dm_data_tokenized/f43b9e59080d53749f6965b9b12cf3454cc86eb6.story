...
For now there is no mobile version , it does n't loop in Instagram , there 's no API ( which would allow outside developers to build related apps ) , and it 's only in English .
