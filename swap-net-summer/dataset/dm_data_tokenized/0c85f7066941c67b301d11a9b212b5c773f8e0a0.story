...
According to Perlman , OnLive 's technology will make it possible to stream the games in such a manner -- high quality , no matter what kind of system the user has -- by virtue of a series of patented and patent - pending compression technologies . And instead of requiring users to download the games , OnLive will host them all and stream them from a series of the highest - end servers . Users will have only to download a 1 MB plug - in to get the service up and running .
