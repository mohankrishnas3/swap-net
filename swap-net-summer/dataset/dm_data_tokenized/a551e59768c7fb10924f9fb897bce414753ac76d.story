...
Of course , the features that make the Pavilion dv6985se special are also its downside . That extra battery does add weight , and the flashy design certainly is n't for everyone ( though we happen to love it ) .
...
The retail - only Pavilion dv6985se comes in a single fixed configuration that includes a 2.0 GHz Intel Core 2 Duo processor -- part of Intel 's previous - generation Centrino platform and the standard for mainstream systems -- plus a generous 4 GB of RAM . Paired with 64 - bit Windows Vista , that 4 GB of RAM gave the Pavilion dv6985se a notable boost on our Photoshop CS3 benchmark , where the first three spots among Back - to - School systems went to 64 - bit - equipped laptops .
