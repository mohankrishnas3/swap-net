...
The card is powered by a tiny battery , and generates a different security code ( usually the three digit code printed on the back ) every time it 's switched on . The number stored in the magnetic strip also changes - so it ca n't be cloned , at least with current technology .
