...
He further explains his live setup , revealing the heavy data transfers in sync with the light show only allow him a certain limited flexibility . " There 's a good chunk of MIDI [ Musical Instrument Digital Interface ] data spitting out as well to a handful of synths and crap that are / were used in the actual produciton ... which i can tweak * live * and whatnot ... but does nt give me a lot of ' lookit me im Jimi Hendrix check out this solo ' stuff , because I 'm constrained to work on a set timeline because of the SMPTE [ Society of Motion Picture and Television Engineers timestamp ] . "
