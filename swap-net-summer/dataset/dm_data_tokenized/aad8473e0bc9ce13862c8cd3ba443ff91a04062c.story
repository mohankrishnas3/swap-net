...
A representative from Merck said in a statement to MailOnline : ' On the rare occasion that an implant can not be located by the doctor or nurse feeling for the implant prior to an attempted removal and an ENG ( hormone ) test is positive , indicating that an implant has previously been inserted , there are various methods which can be used to help locate the implant .
