...
This implantable antenna uses the 402 - 405 MHz Medical Implant Communications Service ( MICS ) frequency band . Combined with a custom integrated chip or a system on a chip , device makers can use the antenna in pacemakers , neurostimulation devices , and swallowable imaging and diagnostic systems .
