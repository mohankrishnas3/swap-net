...
In contrast , the first model of the Surface tablet ( Windows RT only ) will only offer the Metro interface , so it wo n't be able to run the full versions of many desktop apps popular with Windows users , such as Photoshop .
