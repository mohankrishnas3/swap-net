...
Santorum did not submit any delegate slates in three districts ( congressional districts 6 , 9 , and 13 ) , which means he can not win any delegates from these districts . In six additional districts ( CDs 3 , 4 , 8 , 10 , 12 , and 16 ) , he submitted only partial delegate slates , which means that if Santorum wins any of these districts , he will only receive one or two out of the three possible delegates in that district .
