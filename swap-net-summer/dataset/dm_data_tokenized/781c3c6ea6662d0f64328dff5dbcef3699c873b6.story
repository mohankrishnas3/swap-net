...
Of course , the Pebble team has n't gotten its hands on the money yet . The Kickstarter campaign officially ends on May 18 , at which point all backers ' credit cards will be charged , and funding will be transferred to Pebble . ( Kickstarter takes a 5 percent cut of the total raised money . )
...
The Pebble team calls its watch 's display an e-paper display , in order to highlight its readability in direct sunlight . The specific component Pebble uses , however , is Sharp 's 1.26 - inch Memory LCD . This screen does n't use the anti-reflective e-ink that 's so familiar in Kindle and Nook e-readers . Rather , it 's a reflective display that uses a PNLC ( Polymer Networked Liquid Crystal ) module for improved brightness , and HR - TFT ( high - reflective thin film transistor ) technology to add contrast .
...
The " Big Board " as Migicovsky calls it , executes all the features that you 'll see in the final Pebble . There are four buttons , a 3 - axis accelerometer , a vibrating motor , Bluetooth 2.1 + EDR and 4.0 , a microcontroller , and 4 MB of memory .
