...
" That 's the benefit of our approach : the user does the crowdsourcing for us , " explains Zacharia . The advantage of Kayak 's model is it relies on an enormous amount of data to make predictions . The downfall is that niche destinations ( those that are n't searched as often ) are often overlooked .
