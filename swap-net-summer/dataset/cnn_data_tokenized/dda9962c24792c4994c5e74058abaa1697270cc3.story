...
This increase in accuracy targeting both high - level and lower - level al - Qaeda and Taliban members appears to stem from the CIA 's use of smaller missiles and increased cooperation with the United States ' Pakistani counterparts who , despite public protests about violations of their national sovereignty by the drone strikes , have quietly been sharing vital intelligence . An unnamed U.S. official commented , " You need guys on the ground to tell you who they [ the targets ] are and that is n't coming from some white guy running around the FATA . "
