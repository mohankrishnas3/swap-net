...
According to data analyzed by Validas , about half of AT&T 's iPhone customers use less than 200 MB of data per month . And about 47 percent of their iPhone subscribers use between 200 MB and 2 GB of data with about 90 percent of those customers using less than 1 GB of data per month . This means that about 2.5 percent of AT&T 's users consume more than 2 GB of data per month .

Hard - core data users

Verizon Wireless smartphone subscribers have similar usage patterns to those on AT&T 's network . But where they differ is in the number of subscribers that are using between 500 MB to 1 GB per month of data . Verizon has twice as many of those customers than AT&T has , Finegold said . More than 11 percent of Verizon Wireless smartphone users fall into this category , versus just 5.6 percent of iPhone users .
...
In an effort to keep iPhone data usage in check so it does n't completely overwhelm its network , AT&T recently eliminated its all you - can - eat data plan . Instead the company offers two tiers of services . For $ 15 a month , new smartphone subscribers can get up to 200 MB of data per month . And for $ 25 a month they can get 2 GB of data .
...
AT&T 's new pricing only affects a small number of customers . But if Verizon were to adopt the very same pricing model , more of its heavy data users on Android phones would likely be affected . According to the Validas report , a little more than 4 percent of Verizon 's smartphone users consume more than 2 GB of data per month compared with only about 2.5 percent of AT&T 's iPhone customers .
...
For example , about half of Sprint 's cell phone subscribers , including smartphone customers , use data on Sprint 's network . But the average usage is only about 133.4 MB a month . T - Mobile only has about 22.3 percent of its cell phone subscriber base subscribing to data , and those consumers are only using about 120 MB of data per month .
