...
The challenge of economic prediction is daunting even for much simpler legislation . But instead , the CBO did n't even try to predict how the law would alter economic decisions ( using " dynamic " scoring , as it should be required to do ) . Using its static models , the agency assumed key provisions would change no one 's behavior .
