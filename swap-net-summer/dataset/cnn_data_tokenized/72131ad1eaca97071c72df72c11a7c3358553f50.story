...
In this instance , for example , if the dude wanted to go on a date , he could send a friendly first message ( not mentioning the unwitting run - in ) . Then , if things were rolling along after a few dates , he could mention it in a fun , " You wo n't believe how serendipitous this was ! " kind of way .
