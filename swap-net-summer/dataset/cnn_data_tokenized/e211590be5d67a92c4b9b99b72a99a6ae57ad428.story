...
According to the news release , " RIM will launch two optional ' app players ' that provide an application run - time environment for BlackBerry Java apps and Android v 2.3 apps . These new app players will allow users to download BlackBerry Java apps and Android apps from BlackBerry App World and run them on their BlackBerry PlayBook . "
...
Crackberry clarified , " This does n't mean that RIM is working with Google to bring Android marketplace to BlackBerry , but rather that developers who have made Android apps can sign up as BlackBerry App World developers ( which is now free of charge ) and distribute their apps to BlackBerry PlayBook owners via App World . "
