...
Alaska has the highest reported rate of fetal alcohol syndrome in the United States , according to a 2010 report by the state 's Department of Health and Social Services . Health officials estimate that in Alaska , 126 babies born each year are affected by prenatal alcohol use ( out of roughly 731,000 people in 2010 , one of the lowest state populations ) . However , most states do n't have comprehensive data about their rates , making it difficult to draw national comparisons .
