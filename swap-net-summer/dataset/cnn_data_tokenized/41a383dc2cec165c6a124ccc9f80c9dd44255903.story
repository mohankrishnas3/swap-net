( Mashable ) -- Windows 8 wo n't be ready for consumers until fall , but that 's not stopping hardware makers from fighting to be first in line to build hardware for Microsoft 's new operating system .
...
While the new version of Windows has been engineered to be near - identical on both , ARM - based Windows devices are going to be " end - to - end " devices ( meaning Windows would come fully integrated ) and have a few special features , like an ultra-low-power mode . However , most legacy apps wo n't work on them .
