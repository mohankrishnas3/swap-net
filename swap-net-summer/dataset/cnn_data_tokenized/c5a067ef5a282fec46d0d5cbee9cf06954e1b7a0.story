...
The study shows only an association , not cause and effect , so Burns and his colleagues ca n't be sure that Alzheimer 's directly causes weight loss ( or prevents weight gain ) . In fact , the researchers found no association between BMI changes and Alzheimer 's biomarkers in a subset of study participants whose weight was tracked for two years .
