...
The common thread : Yahoo keeps expanding into new areas , even though it was already a sprawling internet conglomerate when Mayer took control , with everything from movie listings to stock quotes to a photo - sharing social network to a news hub to a search engine . ( And do n't forget the " OMG ! " section . )
