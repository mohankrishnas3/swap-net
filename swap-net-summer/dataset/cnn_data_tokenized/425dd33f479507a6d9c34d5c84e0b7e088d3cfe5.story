( CNN ) -- Cars have Global Positioning System devices to pinpoint where drivers are when they get lost , so why ca n't GPS be used to locate the exact position of planes when the worst happens ?
